...
class GoBoard(object):
    ...
    # def staticallyEvaluateMove(self) :
    #     captures = 0
    #     opp_captures = 0
    ...
    #     score = -self.staticallyEvaluateMove()
    ...
    #     score = score + 100**len(w) - 100**len(b)
    #     #print("SCORE", score)
    ...
    #     w = []
    #     b = []
    #     lines = self.cols+self.rows+self.diags
    #     for r in lines:
